...
with open('database_handling/cedict_ts.u8') as file:
    text = file.read()
    lines = text.split('\n')
...
#define functions
    ...
    def parse_line(line, list_of_dicts):
        parsed = {}
        if line == '':
    ...
    def remove_surnames(list_of_dicts):
    ...
    def create_dict():
        ...
        for line in dict_lines:
                parse_line(line, list_of_dicts)
        
        #remove entries for surnames from the data (optional):

        print("Removing Surnames . . .")
        remove_surnames(list_of_dicts)
...
#    print(i["traditional"], i["pinyin"], i["english"])

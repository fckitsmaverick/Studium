...
def take_input():
    audio = Prompt.ask("[bold magenta]Do you wish to use the audio input function ? (you will have to speak your answers instead of typing)", choices=["yes", "no"], default="no" ) 
